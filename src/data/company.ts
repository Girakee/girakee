/** Official company information from https://www.girakee.com/ */
...
export const aboutMessaging = {
  headline: 'Global Excellence, Indian Innovation',
  paragraphs: [
    'We are a Bengaluru-based software company founded by digital enthusiasts passionate about accelerating the Digital India mission.',
    'While our roots are proudly in India\'s Silicon Valley, our vision and reach are international. We primarily serve ambitious clients across the US, UK, the Middle East, and the EU. We combine top-tier Indian engineering talent with a deep commitment to delivering services that are not just high-quality, but remarkably affordable.',
  ],
}
